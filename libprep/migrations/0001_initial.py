# Generated by Django 3.2.15 on 2022-09-06 12:03
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('area', models.ForeignKey(blank=True, db_column='area', null=True, on_delete=django.db.models.deletion.SET_NULL, to='areas.areas')),
            ],
            options={
                'db_table': 'nuc_acids',
                'managed': True,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nuc_acid', models.ForeignKey(blank=True, db_column='nuc_acid', null=True, on_delete=django.db.models.deletion.CASCADE, to='libprep.nucacids')),
            ],
            options={
                'db_table': 'sample_lib',
                'managed': True,
