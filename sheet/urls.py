...
urlpatterns = [
    ...
    path("generate_broad_institute", views.generate_broad_institute, name="generate_broad_institute"),
    path("generate_ucsf_cat", views.generate_ucsf_cat, name="generate_ucsf_cat"),
