...
directory = '/Volumes/labshare/BastianRaid-02/HiSeqData/Acral melanoma lines_mRNA_Seq_AL1806051_R1/Meng_md5.txt'
...
def read_rows(row):
    ...
    try:
        ...
        sequencing_run, _ = SequencingRun.objects.get_or_create(name="Acral melanoma lines_mRNA_Seq_AL1806051_R1")
...
df.to_csv("Acral melanoma lines_mRNA_Seq_AL1806051_R1.csv", index=False)
