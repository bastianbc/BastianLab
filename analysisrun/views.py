...
def initialize_import_variants(request, ar_name):
    ...
    return render(request, "import_variants.html", {
        ...
        "ar_location": ar_url,
        "metrics_count": importer.count_files.get("metrics", 0),
        "cnv_count": importer.count_files.get("cnv", 0),
        "cnv_attachments_count": importer.count_files.get("cnv_attachments", 0),
        "snv_count": importer.count_files.get("snv", 0),
...
def check_import_progress(request, ar_name):
    ...
    try:
        ...
        # ✅ Calculate dynamic progress with a minimum threshold of 5%
        if total_files > 0:
